...
const Footer = () => {
  return (
    <footer className="bg-[#014421] text-[#fdfbf5] py-20 px-6 border-t border-[#C5A059]/20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        <div className="space-y-6">
          ...
          <div className="pt-4">
            <p className="text-[10px] font-mono opacity-40">© 2026 CRESCERE STRATEGIES | PROFESSIONAL CONFIDENTIALITY GUARANTEED</p>
          </div>
        </div>

        <div>
          <h4 className="text-[#C5A059] text-[10px] font-bold uppercase tracking-widest mb-6">LEADERSHIP LAB</h4>
          <ul className="space-y-4 text-xs font-medium opacity-70">
            ...
            <li><Link href="/admin" className="text-[#C5A059]/80 hover:text-[#C5A059] transition-colors">Admin Portal</Link></li>
          </ul>
        </div>
