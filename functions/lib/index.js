...
exports.sendBriefingNotification = void 0;
const functions = require("firebase-functions/v1");
const admin = require("firebase-admin");
const nodemailer = require("nodemailer");
admin.initializeApp();
exports.sendBriefingNotification = functions.firestore
    ...
    const mailOptions = {
        ...
        to: 'mreneislas1977@gmail.com',
        subject: `New Briefing Request: ${data.organization}`,
        html: `
